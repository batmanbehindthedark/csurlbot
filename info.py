...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '-1001543052371').split()]
...
DATABASE_NAME = environ.get('DATABASE_NAME', "HarshaCs")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'HarshaCs_Files')
...
DOWNLOAD_TEXT_NAME = "📥 HOW TO GET FILES 📥"
DOWNLOAD_TEXT_URL = "https://t.me/Cs_Osl/3"

   # Custom Caption Under Button #
CAPTION_BUTTON = "JOIN"
CAPTION_BUTTON_URL = "https://CSAdmin69_bot"
