...
async def next_page(bot, query):
    ...
    btn.insert(0,
        [
            InlineKeyboardButton(text="⚡ʜᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ⚡", url='https://t.me/Cs_Osl/3')
        ]
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⚡ JOIN ⚡', url='https:/t.me/cinesandhadhi'),
            InlineKeyboardButton('🤖 UᎮDΛTΞS 🤖', url='https://t.me/cinesandhadhi')
        ], [
